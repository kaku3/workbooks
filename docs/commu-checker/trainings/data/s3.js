...
const S3_CHECK_TEXT = [
  '作業ログから「つまり何か」を1文で書いた',
  'その1文を本文の先頭に置いてから詳細を書いた',
  '先頭1文をメンターに口頭で確認した',
  '具体の事実を3つ選んで共通点を1つ探した',
  '共通点を「一言ラベル」で表現した',
  'ラベルが伝わるか1文で自己確認した',
  '自分の文章を見直して「具体だけで終わる箇所」を1つ見つけた',
  'その箇所に要約1文を追加した',
  '追加後の文章を「初見の人に伝わるか」で再確認した',
  '提出前に「要約1文→具体3点」の順で読んで確認した',
  '要約が曖昧な箇所を1点以上修正した',
  '修正前後の差分をメンターに1行で共有した',
  '書いた文章を1つ選び「事実」と「要点」を分けて書いた',
  '事実3つから要点1つを作って追記した',
  '要約後の文章を自分で読み直し「詰まらないか」を確認した',
  '提出前に「この記録の学び」を1行で書き出した',
  '要点不足を自分で1点以上補ってから提出した',
  '「先回りで要点化できた箇所」をメンターに共有した',
  'WK4〜6で効いた手順を2つ以上組み合わせて使った',
  '「自分の要点化手順」をメンターに1分で説明した',
  '意識しなくても具体から要点を引き上げられた場面を1つ見つけた',
  'その瞬間を「どの事実から要点化したか」でメモした',
  '今日のメモを次回1on1で共有できる場所に保存した',
  '相手が詰まりそうな箇所を1つ記録した（なければ「なし」と記録）',
  '受けた指摘を「要点不足/具体過多/順序不足」に分類してメモした',
  '明日の改善アクションを1行で決めた',
  '【自走】今日のタスクで、要点化してから共有できた',
  '【自覚】「なぜ要点化が必要か」を自分の言葉で説明した',
  '【再現】今日の新しいタスクでも要点化手順を再現して使った'
];

const S3_WEEK_GOALS = [
  '毎日、相手に必要な要点を先に置いてから本文を書けた。',
  '毎日、専門用語や略語を聞き手向けに言い換えられた。',
  '毎日、要点不足を1つ見つけて要約できた。',
  '毎日、提出前に聞き手目線のテストを実施できた。',
  '毎日、要点チェックを自分だけで回せた。',
  '毎日、指摘前に要点要約を1回以上実行できた。',
  '毎日、自分に効く要約手順を同じ順番で回せた。',
  '毎日、無意識でできた要点要約の行動を記録できた。',
  '毎日、要点要約のサイクルを自走で完了できた。',
  '毎日、卒業3基準を実タスクで満たせた。'
];
...
<!-- TYPE HERO -->
  <div class="type-hero">
    ...
    <div class="type-hero-bg-icon"><span class="material-icons-round">blur_on</span></div>
  </div>

  <!-- INSIGHT BOX -->
  <div class="insight-box">
    <div class="insight-title"><span class="material-icons-round icon-sm">blur_on</span> 今起きていること</div>
    <div class="insight-diagram">
      <div class="insight-node">
        <div class="node-icon"><span class="material-icons-round">description</span></div>
      ...
      <div class="insight-arrow broken">
        ...
        <div class="insight-gap-label"><span class="material-icons-round" style="font-size:11px;color:var(--red)">link_off</span> 抽象化 不足</div>
      </div>
      <div class="insight-node">
        <div class="node-icon"><span class="material-icons-round">summarize</span></div>
  ...
  <div class="week-block phase-1" id="week-1">
    ...
    <div class="week-body">
      <div class="week-goal">
        <strong>今週のゴール：</strong>${S3_WEEK_GOALS[0]}
      </div>
