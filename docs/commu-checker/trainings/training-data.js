...
<!-- TYPE HERO -->
  ...
  <div class="insight-box">
    <div class="insight-title"><span class="material-icons-round icon-sm">analytics</span> 今起きていること</div>
...
<!-- TYPE HERO -->
  ...
  <div class="insight-box">
    ...
    <div class="insight-diagram">
      <div class="insight-node">
        <div class="node-icon"><span class="material-icons-round">psychology</span></div>
      ...
      <div class="insight-node">
        <div class="node-icon"><span class="material-icons-round">visibility</span></div>
...
<!-- TYPE HERO -->
  <div class="type-hero">
    ...
    <div class="type-hero-bg-icon"><span class="material-icons-round">memory</span></div>
  </div>
  ...
  <div class="insight-box">
    ...
    <div class="insight-diagram">
      ...
      <div class="insight-arrow broken">
        ...
        <div class="insight-gap-label"><span class="material-icons-round" style="font-size:11px;color:var(--red)">link_off</span> 保持 不足</div>
      </div>
      <div class="insight-node">
        <div class="node-icon"><span class="material-icons-round">visibility</span></div>
